...
const LoginLeftSide = () => {
  return (
    <div className="hidden md:flex w-1/2 bg-indigo-950 relative overflow-hidden border-r border-slate-200">
        ...
        <div className="relatibe z-10 flex flex-col items-start justify-center p-12 lg:p-20 w-full h-full">
            ...
            <p className="text-slate-400 text-lg max-w-md leading-relaxed">Streamline workforce management with effortless attendance tracking, payroll automation, and secure employee management.</p>
        </div>
    </div>
  )
}
